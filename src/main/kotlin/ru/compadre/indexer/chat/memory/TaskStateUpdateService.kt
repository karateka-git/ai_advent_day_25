...
class TaskStateUpdateService(
    ...
    private companion object {
        ...
        private val SYSTEM_PROMPT = """
            ...
            - В `lastUserIntent` обязательно сохраняй ключевые сущности, активную тему/документ и предмет запроса.
            - Для зависимых follow-up вопросов раскрывай местоимения и контекст, не пиши расплывчатые формулировки вроде "уточнить детали" без объекта.
            - Пример плохого `lastUserIntent`: "Уточнить детали".
            - Пример хорошего `lastUserIntent`: "Найти в тексте «Реформа» дополнительные детали происхождения богини Реформы".

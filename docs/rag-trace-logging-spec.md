...
В проекте `day_25` уже есть рабочий RAG pipeline:
...
Нужно сделать похожий по духу механизм для `day_25`, но с учётом текущей архитектуры проекта.

---

## Главная цель

Построить в `day_25` систему trace-логирования, которая:
...
1. В `day_25` уже есть чёткие слои:
...
Нужно не просто “добавить ещё логов”, а ввести в `day_25` отдельную trace-подсистему по образцу `day_14`:
